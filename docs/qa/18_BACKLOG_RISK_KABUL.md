...
| B-04 | PDF piksel/Türkçe font görsel QA | Örnek PDF’lerin manuel/görsel kontrolü | P2 | Kısmi — `qa_pdf_turkish_smoke.py` (magic + DejaVu + İŞĞÜÖÇ) |
...
Canlı API doğrulama (2026-07-20): **0.9.64** yayında — `schema_bootstrap: alembic-only-v1`, `clamav_scan: disabled`, `render_warmup: cron-14m`, canlı smoke 13/13.
