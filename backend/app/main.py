...
from app.services.remote_training_document_extension import install_remote_training_document_extension
...
_remote_training_document_extension_status = install_remote_training_document_extension()
...
logger.info("remote training document extension: %s", _remote_training_document_extension_status)
...
for router in (
    ...
    individual_specialist_approval.eisa_router,
    eisa.router,
    eisa_emails.router,
    ...
    workplace_training_records.router,
    workplace_portal.router,
    workplace_backups.router,
