...
from app.api import auth, branches, companies, dashboard, employees, users, isg_records, health, documents, annual_plans, reports, security, files, exports, subscriptions, notifications, system, osgb, operations, trainings, risks, incidents, ppe, sds, drills, eisa, osgb_applications, archives
...
async def lifespan(_:FastAPI):
    ...
    with SessionLocal() as db:
        ...
        try:
            ...
            pass
    yield
app=FastAPI(title=settings.app_name,version='0.9.133',lifespan=lifespan)
...
def health():
    ...
    return {
        ...
        'acil_ekipler': 'menu-placeholder-v1',
