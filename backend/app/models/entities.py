...
class Company(Base):
    ...
    # Risk değerlendirme belgesi künyesi (yenileme takibi + rapor ekip satırları)
    risk_assessment_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    risk_team_employee_rep: Mapped[str | None] = mapped_column(String(160), nullable=True)
    risk_team_support_staff: Mapped[str | None] = mapped_column(String(160), nullable=True)
    risk_method: Mapped[str | None] = mapped_column(String(40), nullable=True)
    risk_document_no: Mapped[str | None] = mapped_column(String(80), nullable=True)
    risk_revision_no: Mapped[str | None] = mapped_column(String(20), nullable=True)
    risk_revision_reason: Mapped[str | None] = mapped_column(String(500), nullable=True)
...
class HealthRecord(Base):
    ...
    spirometry_result: Mapped[str | None] = mapped_column(Text, nullable=True)
    chest_xray_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    chest_xray_result: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    exposures: Mapped[str | None] = mapped_column(Text, nullable=True)
    follow_up_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    other_biological_test: Mapped[str | None] = mapped_column(Text, nullable=True)
