...
WORKPLACE_MANAGER_MODULES = {"workplace_home", "workplace_status", "employer_oversight", "eyas_inbox", "employees", "ppe", "periyodik_kontrol", "ortam_olcum", "sds", "accident", "near_miss", "capa", "isg_kurulu", "tatbikat", "personnel_training_records", "remote_training", "documents", "health", "site_qr_kiosk"}
WORKPLACE_KIOSK_MODULES = WORKPLACE_MANAGER_MODULES
...
MODULE_DESTINATIONS = (
    (("ana panel", "ana sayfa", "isg ozeti", "işg özeti", "dashboard"), "dashboard", "Ana Panele git"),
    (("risk analizi", "risk degerlendirme", "risk değerlendirme"), "risk", "Risk Analizine git"),
    (("is kazasi", "iş kazası", "kaza kaydi", "kazalar", "kaza"), "accident", "İş Kazalarına git"),
    (("ramak kala", "ramakkala", "ramakkalayi", "ramak kalayi"), "near_miss", "Ramak Kala modülüne git"),
    (("dof", "döf", "capa", "duzeltici", "düzeltici"), "capa", "DÖF modülüne git"),
    (("acil durum ekipleri", "acil ekipler", "destek elemanlari"), "acil_ekipler", "Acil Durum Ekiplerine git"),
    (("acil durum plani", "acil durum planı", "acil plan", "kroki"), "acil_plan", "Acil Durum Planına git"),
    (("yillik degerlendirme", "yıllık değerlendirme", "degerlendirme raporu"), "annual_eval_report", "Yıllık Değerlendirme Raporuna git"),
    (("yillik plan", "yıllık plan"), "annual_plans", "Yıllık Plana git"),
    (("belge onay", "belge imza"), "belge_onay", "Belge Onaya git"),
    (("alt isveren", "alt işveren", "yuklenici", "yüklenici", "taseron", "taşeron"), "contractors", "Alt İşverenlere git"),
    (("musteri portali", "müşteri portalı"), "customer_portal", "Müşteri Portalına git"),
    (("dokuman", "doküman"), "documents", "Dokümanlara git"),
    (("personel", "calisan", "çalışan"), "employees", "Personel Yönetimine git"),
    (("tesis ozeti", "tesis özeti", "tesis uygunluk"), "facility_summary", "Tesis Özetine git"),
    (("saha denetimi", "saha denetim"), "field_inspection", "Saha Denetimine git"),
    (("saha pwa", "saha hizli", "saha hızlı işlem"), "field_pwa", "Saha Hızlı İşleme git"),
    (("isg kurulu", "işg kurulu"), "isg_kurulu", "İSG Kuruluna git"),
    (("mevzuat",), "mevzuat", "Mevzuata git"),
    (("bildirim",), "notifications", "Bildirimlere git"),
    (("ortam olcum", "ortam ölçüm"), "ortam_olcum", "Ortam Ölçümüne git"),
    (("periyodik kontrol",), "periyodik_kontrol", "Periyodik Kontrole git"),
    (("kisisel koruyucu", "kişisel koruyucu", "kkd takip", "k k d", "ka ka de", "kkd", "ppe"), "ppe", "KKD Takibe git"),
    (("guvenlik", "güvenlik"), "security", "Güvenliğe git"),
    (("guvenlik bilgi formu", "sds", "pkd"), "sds", "SDS / PKD sayfasına git"),
    (("uzman rapor",), "specialist_reports", "Uzman Rapor Merkezine git"),
    (("tatbikat",), "tatbikat", "Tatbikatlara git"),
    (("uzaktan egitim", "uzaktan eğitim"), "remote_training", "Uzaktan Eğitime git"),
    (("egitim", "eğitim"), "training", "Eğitimlere git"),
    (("ziyaret defteri", "defter yukle", "defter yükle"), "visit_notebook", "Ziyaret Defterine git"),
    (("ziyaret qr", "qr okut"), "visit_qr", "Ziyaret QR sayfasına git"),
    (("ziyaretci", "ziyaretçi"), "visitors", "Ziyaretçilere git"),
    (("saha takvimi", "ziyaretler", "takvim", "ziyaret"), "visits", "Saha Takvimine git"),
    (("calisma izni", "çalışma izni"), "work_permits", "Çalışma İzinlerine git"),
    (("isyeri durumu", "işyeri durumu", "durum merkezi"), "workplace_status", "İşyeri Durumuna git"),
    (("denetim",), "field_inspection", "Saha Denetimine git"),
    (("risk",), "risk", "Risk Analizine git"),
    (("rapor",), "specialist_reports", "Uzman Rapor Merkezine git"),
    (("belge",), "documents", "Dokümanlara git"),
)
DIRECT_ALIASES = {
    "ana panel", "ana sayfa", "dashboard", "isg ozeti", "işg özeti",
    "risk analizi", "risk",
    "is kazasi", "iş kazası", "kazalar", "kaza",
    "ramak kala", "ramakkala", "ramakkalayi", "ramak kalayi",
    "dof", "döf", "capa",
    "acil durum ekipleri", "acil ekipler",
    "acil durum plani", "acil durum planı", "acil plan",
    "yillik degerlendirme", "yıllık değerlendirme",
    "yillik plan", "yıllık plan",
    "belge onay",
    "alt isveren", "alt işveren", "yuklenici", "yüklenici", "taseron", "taşeron",
    "musteri portali", "müşteri portalı",
    "dokuman", "doküman",
    "personel", "calisan", "çalışan",
    "tesis ozeti", "tesis özeti",
    "saha denetimi", "saha denetim",
    "saha pwa", "saha hizli",
    "isg kurulu", "işg kurulu",
    "mevzuat",
    "bildirim",
    "ortam olcum", "ortam ölçüm",
    "periyodik kontrol",
    "kkd", "k k d", "ka ka de", "kkd takip", "kisisel koruyucu", "kişisel koruyucu", "ppe",
    "guvenlik", "güvenlik",
    "sds", "pkd", "guvenlik bilgi formu",
    "uzman rapor",
    "tatbikat",
    "egitim", "eğitim",
    "ziyaret defteri", "defter yukle", "defter yükle",
    "ziyaret qr", "qr okut",
    "ziyaretci", "ziyaretçi",
    "saha takvimi", "ziyaretler",
    "calisma izni", "çalışma izni",
    "isyeri durumu", "işyeri durumu",
}
...
MODULE_TITLES = {
    ...
    "annual_eval_report": "Yıllık Değerlendirme Raporu",
    ...
    "facility_summary": "Tesis Özeti",
    "field_inspection": "Saha Denetimi",
    "field_pwa": "Saha Hızlı İşlem",
    ...
    "security": "Güvenlik",
    "sds": "SDS / PKD",
    "specialist_reports": "Uzman Rapor Merkezi",
    "tatbikat": "Tatbikatlar",
    "training": "Eğitimler",
    "remote_training": "Uzaktan Eğitim / Belgeler",
    "visit_notebook": "Ziyaret Defteri",
    "visit_qr": "Ziyaret QR",
    "visitors": "Ziyaretçiler",
    "visits": "Saha Takvimi",
    "work_permits": "Çalışma İzinleri",
    "workplace_status": "İşyeri Durumu",
    "companies": "İşyerleri",
    "health": "Sağlık",
    "reports": "Raporlar",
}
