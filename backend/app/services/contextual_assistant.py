...
WORKPLACE_MANAGER_MODULES = {"employer_oversight", "eyas_inbox", "employees", "ppe", "periyodik_kontrol", "ortam_olcum", "sds", "accident", "near_miss", "capa", "isg_kurulu", "personnel_training_records", "documents", "health", "site_qr_kiosk"}
