...
WORKPLACE_MANAGER_MODULES = {"workplace_home", "workplace_status", "employer_oversight", "eyas_inbox", "employees", "ppe", "periyodik_kontrol", "ortam_olcum", "sds", "accident", "near_miss", "capa", "isg_kurulu", "personnel_training_records", "remote_training", "documents", "health", "site_qr_kiosk"}
