    ...
    return [
        {
            ...
            "residual_probability": getattr(r, "residual_probability", None),
            "residual_frequency": getattr(r, "residual_frequency", None),
            "residual_severity": getattr(r, "residual_severity", None),
            "residual_score": getattr(r, "residual_score", None),
            "residual_level": getattr(r, "residual_level", None),
            "status": r.status,
