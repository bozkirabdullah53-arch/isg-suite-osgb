"""RLS expand: contracts / QR sessions / isg_records / unplanned (P1-03).

Revision ID: 0050
Revises: 0049

company_id kapsamı — UI/flag değişmez.

NOT: workplace_assignments bilerek hariç.
apply_rls_user → assigned_company_ids bu tabloyu okur; aynı policy
ile FORCE RLS chicken-egg (boş allowed → saha kullanıcısı kör) riski taşır.
"""
