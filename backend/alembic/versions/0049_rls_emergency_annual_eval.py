"""RLS expand: emergency teams / annual eval / departments (P1-03).

Revision ID: 0049
Revises: 0048

company_id kapsamı — UI/flag değişmez; sistem emergency_team_types dokunulmaz
(company_id NULL global satırlar).
"""
