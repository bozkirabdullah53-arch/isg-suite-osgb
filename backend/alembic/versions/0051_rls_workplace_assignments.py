"""RLS expand: workplace_assignments (P1-03) — chicken-egg fix sonrası.

Revision ID: 0051
Revises: 0050

apply_rls_user artık allowed_company_ids hesabında geçici rls_bypass kullanır;
bu tabloya FORCE RLS güvenli.
UI/flag değişmez.
"""
