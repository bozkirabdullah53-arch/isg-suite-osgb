...
export default [
  {ignores: ["dist/**", "node_modules/**", "e2e/**"]},
  {
    files: [
      ...
      "src/legal_docs.jsx",
      "src/employee_self_service_logic.js",
      "src/employee_self_service_logic.test.js",
      "src/employee_self_service.jsx",
      "src/pwa_shortcut_prompt_logic.js",
      "src/pwa_shortcut_prompt_logic.test.js",
      "src/pwa_shortcut_prompt.jsx",
