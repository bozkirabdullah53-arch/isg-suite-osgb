...
const FALLBACK_SECTORS = [
  ...
  {code: 'education_universities', label: 'Eğitim Kurumları ve Üniversiteler'},
  {code: 'public_municipalities', label: 'Kamu Kurumları ve Belediyeler'},
  {code: 'agriculture_livestock_forestry', label: 'Tarım, Hayvancılık ve Ormancılık'},
  {code: 'hospitality_tourism_restaurants', label: 'Konaklama, Turizm ve Restoran'},
  {code: 'trade_retail_markets', label: 'Ticaret, Perakende ve Marketler'},
  {code: 'energy_electricity_gas', label: 'Enerji, Elektrik ve Doğalgaz'},
  {code: 'water_sewerage_waste', label: 'Su, Kanalizasyon ve Atık Yönetimi'},
  {code: 'textile_clothing_leather', label: 'Tekstil, Giyim ve Deri'},
  {code: 'plastic_rubber', label: 'Plastik ve Kauçuk'},
  {code: 'wood_furniture', label: 'Ağaç ve Mobilya'},
  {code: 'ceramic_glass_marble', label: 'Seramik, Cam ve Mermer'},
  {code: 'building_cleaning_security', label: 'Bina, Temizlik ve Güvenlik Hizmetleri'},
  {code: 'automotive_vehicle_services', label: 'Otomotiv ve Araç Servisleri'},
